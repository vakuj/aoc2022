...
If there is no
* Elf in the N, NE, or NW adjacent positions, the Elf proposes moving north one step.
* Elf in the S, SE, or SW adjacent positions, the Elf proposes moving south one step.
* Elf in the W, NW, or SW adjacent positions, the Elf proposes moving west one step.
* Elf in the E, NE, or SE adjacent positions, the Elf proposes moving east one step.
